    ...
    <div className="max-w-sm relative bg-[#1A1A1A] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <section className="relative">
        <Link to={`/product/${p._id}`}>
          <span className="absolute bottom-3 right-3 bg-purple-100 text-purple-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-purple-900 dark:text-purple-300">
            {p?.brand}
          </span>
          <img
            src={p.image}
      ...
      <div className="p-5">
        <div className="flex justify-between">
          ...
          <p className="mt-1 font-semibold text-purple-500">
